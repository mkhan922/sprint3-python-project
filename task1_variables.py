...
sum_global_sales = sum(game[GLOBAL_SALES] for game in video_game_sales)
avg_global_sales = sum_global_sales / total_games
print("Average global sales:", avg_global_sales)

#% of total Global Sales Wii Sports holds
sum_global_sales = sum(game[GLOBAL_SALES] for game in video_game_sales)
top_game_share = ((video_game_sales[0][GLOBAL_SALES]) / sum_global_sales) * 100
print("Wii Global Shares Percentage:", top_game_share, "%")
